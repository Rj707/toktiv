...
/** Cleanly shut down the messaging subsystem when you are done with it. 
 ...
 After calling this method strong references to all objects created and returned by the Chat client
 must be released (i.e TCHChannel, TCHMessage, TCHMember, TCHUser etc).
*/
- (void)shutdown;
...
/**
 ...
 Setting this property to `true` for a Chat Client instance will defer to iOS to
...
/**
 * If useProxy flag is `true` TCHConversationsClient will try to read and apply system proxy settings
